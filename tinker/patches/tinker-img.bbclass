...
EOF
	...
	mcopy -i ${WORKDIR}/${BOOT_IMG} -s ~/build-yocto-lxde/tinker/patches/rk3288.conf ::/extlinux/extlinux.conf
	mcopy -i ${WORKDIR}/${BOOT_IMG} -s ~/build-yocto-lxde/tinker/patches/hw_intf.conf ::
