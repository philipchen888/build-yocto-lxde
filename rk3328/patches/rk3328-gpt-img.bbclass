...
IMAGE_TYPEDEP_rk3328-gpt-img = "${IMG_ROOTFS_TYPE}"
...
EOF
	...
	mcopy -i ${WORKDIR}/${BOOT_IMG} -s ~/build-yocto-lxde/rk3328/patches/rk3328.conf ::/extlinux/extlinux.conf
	# Burn Boot Partition
